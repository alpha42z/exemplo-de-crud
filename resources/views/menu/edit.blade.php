        ...
        <div class="card-body">
          <form class="form-horizontal" action="{{ route('menu.update', $menu->id) }}" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="name_pt" type="text" class="form-control {{ $errors->has('name_pt') ? 'is-invalid' : '' }}" value="{{ $menu -> name_pt }}" placeholder="Nome do Menu">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="name_en" type="text" class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" value="{{ $menu -> name_en }}" placeholder="Nome do Menu">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="name_cn" type="text" class="form-control {{ $errors->has('name_cn') ? 'is-invalid' : '' }}" value="{{ $menu -> name_cn }}" placeholder="Nome do Menu">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="position" type="text" class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" " value="{{ $menu -> position }}" placeholder="Posição no Menu">
            ...
            <div class="form-group col-sm-6">
              ...
              <select name="parent_id" class="form-control" id="submenu">
                ...
                @foreach ($menus as $menu)
                  <option value="{{ $menu -> id }}" @if($parentId == $menu->id) selected @endif>{{ $menu -> name_pt }}</option>
                @endforeach
              </select>
            </div>
            ...
            * não preencher o link se esse for um menu com submenus.</div>
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="link" type="text" class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" value="{{ $menu -> link }}" placeholder="link">
                @if($errors->has('link'))
